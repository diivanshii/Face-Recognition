...
s3 = boto3.client('s3', aws_access_key_id='AKIA5FTZAKANZQNK6UXE',
                  aws_secret_access_key='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')
bucket_name = 'famouspersonss-images'
